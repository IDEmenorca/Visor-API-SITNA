...
TC.control.Search = function () {
    ...
    self.availableSearchTypes[TC.Consts.searchType.CADASTRAL] = {
        ...
        //parser: self.getCadastralRefSilme,
...
(function () {
	...
	//=================================
	//Modificación SILME: 2018-08-1
    //=================================
	ctlProto.getCadastralRefSilme = function (pattern) {
		
		console.log("getCadastralRefSilme");
    ...
    ctlProto.getStringPattern = function (allowedRoles, pattern) {
        ...
        //Silme pattern = normalizedCriteria(pattern);
