    ...
    ctlProto.register = function (map) {
        ...
        self._$div
            ...
            .on('change input', 'input[type=range]', function (e) {
                var $range = $(e.target);
                silmeMap.parent.baseLayer.setOpacity($range.val() / 100);
            });
        /*End Silme*/
    };
    ...
    ctlProto.update = function () {
        ...
        self._$div.find('ul.' + self.CLASS + '-branch').children('li').each(function (idx, elm) {
            ...
            if (checked) {
                ...
                self._$div.find('input[type=range]').val(100);//Silme
                if (silmeMap.parent.baseLayer != null)//Silme
                    silmeMap.parent.baseLayer.setOpacity(1);//Silme
            }
        });
