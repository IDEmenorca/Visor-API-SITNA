...
namespace visor2018
{
    public partial class DBRequest : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string tramExtent(string tram, string srs)
        {
            string dades = "";
            support.pGisConn pGisConn;
            pGisConn = support.obteParametresConnexio("carto");
            ...
            DataSet ds = pgis.BD_Query($"select st_extent(st_transform(the_geom, {srs})) from silme.or007cca_ccavalls where idtram = '{tram}'");
        ...
        [WebMethod]
        public static string fitaExtent(string fita, string srs)
        {
            string dades = "";
            support.pGisConn pGisConn;
            pGisConn = support.obteParametresConnexio("carto");
            ...
            DataSet ds = pgis.BD_Query($"SELECT st_extent(st_transform(the_geom, {srs})) FROM silme.or007cca_senyalitzacio where idfita = '" + fita + "'");
        ...
        [WebMethod]
        public static string viaExtent(string via, string srs)
        {
            string dades = "";
            string ret = "";
            ...
            try
            {
                ...
                DataSet ds = pgis.BD_Query($"SELECT st_extent(st_transform(the_geom, {srs})) FROM silme.re007rus_puntsquilometrics where idxarxa = '{via}'");
                DataTable dt = ds.Tables[0];
        ...
        [WebMethod]
        public static string pkExtent(string pk, string srs)
        {
            string dades = "";
            string ret = "";
            ...
            try
            {
                ...
                DataSet ds = pgis.BD_Query($"SELECT st_extent(st_transform(the_geom, {srs})) FROM silme.re007rus_puntsquilometrics where etiqueta = '{pk}'");
                DataTable dt = ds.Tables[0];
        ...
        public static string actualitzaPortals(string car, string nuc)
        {
            ...
            try
            {
                if (car != "")
                {
                    string muni = nuc.Substring(nuc.IndexOf('_') + 1);
                    car = car + "_" + muni;
                }
                ...
                DataSet ds = pgis.BD_Query($"select idcarrer, idportal, nomportal from silme.re007urb_portals where idnucli = '{nuc}' and idcarrer = '{car}' order by nomportal");
                ...
                if (dt.Rows.Count != 0)
                {
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        dades += row["idportal"].ToString() + "*" + row["nomportal"].ToString() + ";";
                    }
                    dades = dades.Substring(0, dades.Length - 1);
                }
            }
        ...
        [WebMethod]
        public static string municipiExtent(string mun, string srs)
        {
            string dades = "";
            string id = "";
            string ret = "";
            ...
            try
            {
                ...
                DataSet ds = pgis.BD_Query($"select st_extent(st_transform(the_geom, {srs})), idmun from silme.re007rus_municipis where idmun = '{mun}' group by idmun");
                DataTable dt = ds.Tables[0];
        ...
        [WebMethod]
        public static string nucliExtent(string nuc, string srs)
        {
            string dades = "";
            string id = "";
            string ret = "";
            ...
            try
            {
                ...
                DataSet ds = pgis.BD_Query($"select st_extent(st_transform(the_geom, {srs})), idnucli from silme.re007rus_nuclis where idnucli = '{nuc}' group by idnucli");
                DataTable dt = ds.Tables[0];
        ...
        [WebMethod]
        public static string carrerExtent(string car, string mun, string srs)
        {
            string dades = "";
            string id = "";
            string ret = "";
            ...
            try
            {
                ...
                DataSet ds = pgis.BD_Query($"SELECT st_extent(st_transform(geom, {srs})), (cod_via || '_' || cod_muni) as cod_carrer FROM sit.sit_cae1mv1_112l where cod_via = '{car}' and cod_muni = '{mun}' group by cod_via, cod_muni");
                DataTable dt = ds.Tables[0];
        ...
        [WebMethod]
        public static string portalExtent(string por, string mun, string srs)
        {
            string dades = "";
            string id = "";
            string ret = "";
        ...
        [WebMethod]
        public static string vedatCoordsExtent(string ved, string srs)
        {
            string dades = "";
            string ret = "";
            ...
            try
            {
                ...
                DataSet ds = pgis.BD_Query($"SELECT st_x(st_centroid(st_transform(the_geom, {srs}))), st_y(st_centroid(st_transform(the_geom, {srs}))), st_extent(st_transform(the_geom, {srs})) FROM silme.am007cac_vedats where gid = '{ved}' group by the_geom");
                DataTable dt = ds.Tables[0];
